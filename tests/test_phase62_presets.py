"""§Phase 62: preset composition — imports, params, and the assertions.
...
from utils import cfg_presets, common  # noqa: E402
...
class ReachabilityTest(unittest.TestCase):
    ...
    def test_orphaned_payload_is_rejected(self):
        ...
        with self.assertRaisesRegex(RuntimeError, "outside every scope and preset"):
            common.validate_all_cfg_payload_is_reachable(root.resolve())
